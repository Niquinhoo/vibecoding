...
export default function CodePresentation({ data, onBack }) {
  ...
  // Ahora esperamos 'pasos' (array) en lugar de un código único.
  // Si por alguna razón data.pasos no existe, usamos un array con la data plana para no romper.
  const pasos = data.pasos || [{ id: 1, titulo: data.titulo, descripcion: data.descripcion, codigo: data.codigo || '// Sin código disponible' }];
        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-12 pb-40">
          {pasos.map((paso, index) => (
            <motion.div
              ...
              viewport={{ margin: "-50% 0px -50% 0px" }} // Activa el paso cuando está en el centro
           ...
           {/* Espacio final para permitir scroll del último elemento */}
           <div className="h-[20vh]" />
        </div>

        {/* COLUMNA DERECHA: Código Sticky */}
